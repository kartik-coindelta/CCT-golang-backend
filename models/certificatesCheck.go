...
// CertificatesCheck represents the structure of the certificatesCheck collection in MongoDB.
type CertificatesCheck struct {
	...
	Certificates              interface{}         `bson:"certificates,omitempty"`              // Use interface{} for flexibility with various data types
