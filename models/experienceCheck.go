...
// ExperienceCheck represents the structure of the experienceCheck collection in MongoDB
type ExperienceCheck struct {
	...
	Experience                interface{}        `bson:"experience,omitempty"`                // Use interface{} for flexibility with various data types
