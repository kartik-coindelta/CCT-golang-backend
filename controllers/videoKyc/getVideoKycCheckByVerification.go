...
// GetVideoKycCheckByVerificationID handles the HTTP request to get videoKyc checks by verification ID
func GetVideoKycCheckByVerificationID(c *gin.Context) {
	...
	var results []models.VideoKycCheck
	...
	for cursor.Next(ctx) {
		var result models.VideoKycCheck
