...
// GetExperienceCheckByVerificationID handles the HTTP request to get experience checks by verification ID
func GetExperienceCheckByVerificationID(c *gin.Context) {
	...
	var results []models.ExperienceCheck
	...
	for cursor.Next(ctx) {
		var result models.ExperienceCheck
