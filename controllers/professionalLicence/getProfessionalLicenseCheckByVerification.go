...
// GetProfessionalLicenseCheckByVerificationID handles the HTTP request to get professionalLicense checks by verification ID
func GetProfessionalLicenseCheckByVerificationID(c *gin.Context) {
	...
	var results []models.ProfessionalLicenseCheck
	...
	for cursor.Next(ctx) {
		var result models.ProfessionalLicenseCheck
