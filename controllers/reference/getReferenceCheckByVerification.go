...
// GetReferenceCheckByVerificationID handles the HTTP request to get reference checks by verification ID
func GetReferenceCheckByVerificationID(c *gin.Context) {
	...
	var results []models.ReferenceCheck
	...
	for cursor.Next(ctx) {
		var result models.ReferenceCheck
