...
// GetCriminalCheckByVerificationID handles the HTTP request to get criminal checks by verification ID
func GetCriminalCheckByVerificationID(c *gin.Context) {
	...
	var results []models.CriminalCheck
	...
	for cursor.Next(ctx) {
		var result models.CriminalCheck
