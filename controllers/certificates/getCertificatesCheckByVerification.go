...
// GetCertificatesCheckByVerificationID handles the HTTP request to get certificates checks by verification ID
func GetCertificatesCheckByVerificationID(c *gin.Context) {
	...
	var results []models.CertificatesCheck
	...
	for cursor.Next(ctx) {
		var result models.CertificatesCheck
