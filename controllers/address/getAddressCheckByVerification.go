...
// GetAddressCheckByVerificationID handles the HTTP request to get address checks by verification ID
func GetAddressCheckByVerificationID(c *gin.Context) {
	...
	var results []models.AddressCheck
	...
	for cursor.Next(ctx) {
		var result models.AddressCheck
