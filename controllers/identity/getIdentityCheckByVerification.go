...
// GetIdentityCheckByVerificationID handles the HTTP request to get identity checks by verification ID
func GetIdentityCheckByVerificationID(c *gin.Context) {
	...
	var results []models.IdentityCheck
	...
	for cursor.Next(ctx) {
		var result models.IdentityCheck
