...
// GetEducationCheckByVerificationID handles the HTTP request to get education checks by verification ID
func GetEducationCheckByVerificationID(c *gin.Context) {
	...
	var results []models.EducationCheck
	...
	for cursor.Next(ctx) {
		var result models.EducationCheck
