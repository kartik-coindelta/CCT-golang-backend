...
// GetReputationalCheckByVerificationID handles the HTTP request to get reputational checks by verification ID
func GetReputationalCheckByVerificationID(c *gin.Context) {
	...
	var results []models.ReputationalCheck
	...
	for cursor.Next(ctx) {
		var result models.ReputationalCheck
