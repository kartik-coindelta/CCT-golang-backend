...
// GetGlobalDatabaseCheckByVerificationID handles the HTTP request to get globalDatabase checks by verification ID
func GetGlobalDatabaseCheckByVerificationID(c *gin.Context) {
	...
	var results []models.GlobalDatabaseCheck
	...
	for cursor.Next(ctx) {
		var result models.GlobalDatabaseCheck
