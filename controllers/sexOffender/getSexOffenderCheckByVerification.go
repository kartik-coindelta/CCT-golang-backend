...
// GetSexOffenderCheckByVerificationID handles the HTTP request to get sexOffender checks by verification ID
func GetSexOffenderCheckByVerificationID(c *gin.Context) {
	...
	var results []models.SexOffenderCheck
	...
	for cursor.Next(ctx) {
		var result models.SexOffenderCheck
